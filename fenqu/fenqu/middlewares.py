...
db=mydb['proxy']#表（集合）使用



class FenquSpiderMiddleware(object):
...
class RandomProxyMiddleware(object):
    ...
    def __init__(self):
        self.expire_datetime = datetime.datetime.now() #将当前时间设置为过期时间启动get_proxy获得代理ip
        self.proxy = ''
...
class FenquDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
